...
/**
 * 
 * <p> UEditor文件上传辅助类</br>UEditor文件上传辅助</p>
 * @author shenliang Email:shenliang@co-mall.com
 * @company 北京科码先锋软件技术有限公司@版权所有
 * @version  
 * @since 2015年6月16日下午9:07:25
 */
public class Uploader {

	
	private static final int MAX_SIZE = 500 * 1024;// 文件大小常量, 单位kb
	 ...
	 * HttpServletRequest
	 */
	private HttpServletRequest request = null;// HttpServletRequest
	/**
	 * 标题
	 */
	...
	private long maxSize = 0;// 文件大小限制，单位Byte

	private HashMap<String, String> errorInfo = new HashMap<String, String>();//错误信息Map集合
	
	private Map<String, String> params = null;//参数集
	
	private InputStream inputStream = null;// 上传的文件数据
	...
	/**
	 * 
	 * <p>接受并保存以base64格式上传的文件</br></p>
	 * <p>简要描述该方法的作用以及应用场景</br></p>
	 * @param fieldName
	 */
